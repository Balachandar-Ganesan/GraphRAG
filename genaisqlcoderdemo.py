...
Original file is located at
    https://colab.research.google.com/github/Balachandar-Ganesan/GraphRAG/blob/main/GenAISQLCoderDemo.ipynb
"""
...
question = "select only Number of of matches against every opposition where century was scored"
generated_sql = generate_query(question)
print(generated_sql)